...
define('PAYMONGO_SECRET_KEY',     getenv('PAYMONGO_SECRET_KEY')     ?: 'YOUR_LOCAL_PAYMONGO_KEY_HERE');
define('PAYMONGO_WEBHOOK_SECRET', getenv('PAYMONGO_WEBHOOK_SECRET') ?: 'YOUR_LOCAL_WEBHOOK_KEY_HERE');
define('APP_URL',                 rtrim(getenv('APP_URL')           ?: 'http://localhost:8080/ugat', '/'));
